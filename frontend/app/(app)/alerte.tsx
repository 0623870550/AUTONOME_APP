...
/* ---------------------------------------------
   UPLOAD SUPABASE (Expo-compatible)
---------------------------------------------- */
...
const uploadAttachmentToSupabase = async (
  ...
  try {
    // Lire le fichier en base64 (Expo)
    const fileData = await FileSystem.readAsStringAsync(fileUri, {
      encoding: 'base64',
    });

    // Convertir base64 → Uint8Array (compatible Supabase)
    ...
    <PageContainer>
      <ScrollView contentContainerStyle={{ padding: 20 }}>
        ...
        <View style={{ flexDirection: 'row', flexWrap: 'wrap', gap: 8, marginBottom: 15 }}>
          {[
            { key: 'opérationnelle', label: 'Opérationnelle' },
            { key: 'sous-effectif', label: 'Sous-effectif' },
            { key: 'matériels', label: 'Matériels' },
            { key: 'management', label: 'Management' },
            { key: 'RH', label: 'RH' },
            { key: 'agression', label: 'Agression' },
            ...
            <Pressable
              ...
              style={{
                ...
                borderRadius: 20,
                backgroundColor: type === item.key ? '#FFD500' : 'rgba(255,255,255,0.1)',
              }}
            >
        ...
        <TextInput
          ...
          placeholder="Ex : -2 à la garde, matériel défectueux..."
          placeholderTextColor="#999"
          multiline
          style={{
            borderWidth: 1,
        ...
        {/* SOUHAITE ETRE CONTACTE */}
        <View style={{ flexDirection: 'row', alignItems: 'center', marginBottom: 20 }}>
          <Switch value={commentInterne === 'contact_oui'} onValueChange={(v) => setCommentInterne(v ? 'contact_oui' : '')} />
        ...
        <View style={{ flexDirection: 'row', marginBottom: 15 }}>
          ...
          >
            <Text style={{ color: '#000', fontWeight: 'bold' }}>📸 Image / Vidéo</Text>
          </Pressable>
          ...
          >
            <Text style={{ color: '#000', fontWeight: 'bold' }}>📄 Document</Text>
          </Pressable>
        </View>
