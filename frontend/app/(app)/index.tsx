...
import { Animated, Image, ScrollView, StyleSheet, Text, TouchableOpacity, View, Alert } from 'react-native';
      ...
      <ScrollView contentContainerStyle={styles.scrollContent}>
        ...
        <View style={styles.header}>
          ...
          <View style={styles.headerTextContainer}>
            ...
            <Text style={styles.roleText}>{renderRoleLabel()}</Text>
          </View>
        </View>
        ...
        {news && news.length > 0 ? (
          news.map((item: any) => (
            ...
            >
              ...
              <View style={{ flex: 1 }}>
                <Text style={styles.webTitle}>{item.title}</Text>
                <Text style={styles.webDesc} numberOfLines={2}>{item.content}</Text>
          ...
          <View style={styles.webCard}>
            ...
            <View style={{ flex: 1 }}>
              <Text style={styles.webTitle}>Bienvenue sur l'app</Text>
              <Text style={styles.webDesc}>Consultez régulièrement cette section pour les dernières brèves du syndicat.</Text>
            </View>
          </View>
        )}
